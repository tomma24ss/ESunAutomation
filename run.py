...
if __name__ == "__main__":
    ...
    solar_automation = SolarBoilerAutomation(relay_pin_heatpump, relay_pin_boiler, db_file_path, csv_file_path, vwspotdata_file_path, griddata_file_path, OK_TO_SWITCH)
